...
import { addPokemon,deletePokemon } from '../actions/pokemons';


const TAG = 'AddedLater';
...
class Screen2 extends React.Component {
  ...
  static get options() {
    return Screen2.getDefaultOptions()
  }

  static getDefaultOptions() {
    const options = JSON.parse(JSON.stringify(TitleOptions));
    options.topBar.title.text = 'Added Later';
    ...
    if(dataOrders===null || dataOrders===undefined || dataOrders.length===0) {
      return (
                ...
                <View style={{flex:1,justifyContent:"center",alignItems:"center",marginTop:32}}>
                  <Text style={{fontSize:20}}>No Pokemon Added on Device!</Text>
                </View>
      )
    }
